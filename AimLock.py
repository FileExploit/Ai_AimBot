...
def setup():
    ...
    xy_sens = prompt("X-Axis and Y-Axis Sensitivity (in-game): ")
    targeting_sens = prompt("Targeting Sensitivity (in-game): ")
    ...
    print("[INFO] Sensitivity complete")
...
if __name__ == "__main__":
    ...
    $$ |  $$ |$$ |$$ | $$ | $$ |$$ |     $$ |  $$ |$$ |      $$  _$$<  
    $$ |  $$ |$$ |$$ | $$ | $$ |$$$$$$$$\\$$$$$$  |\$$$$$$$\ $$ | \$$\ 
    \__|  \__|\__|\__| \__| \__|\________|\______/  \_______|\__|  \__|
