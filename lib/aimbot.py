        ...
        while True:
            ...
            if len(results.xyxy[0]) != 0: #player detected
                ...
                if closest_detection: #if valid detection exists
                    ...
                    cv2.line(frame, (closest_detection["relative_head_X"], closest_detection["relative_head_Y"]), (self.box_constant//2, self.box_constant), (0, 242, 113), 2)
...
if __name__ == "__main__": print("Use start.bat")
